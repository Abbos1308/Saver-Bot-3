...
btn1 = KeyboardButton(text="Kanallar")
btn2= KeyboardButton(text="Reklama berish")
btn3 = KeyboardButton(text="Statistika")
btn4 = KeyboardButton(text="Adminlar")
#btn5 = KeyboardButton(text="Bloklash")
btn6 = KeyboardButton(text="Chiqish")
keyboards = ReplyKeyboardMarkup(resize_keyboard=True,row_width=2)
keyboards.add(btn1,btn2)
keyboards.add(btn3,btn4)
keyboards.add(btn6)
